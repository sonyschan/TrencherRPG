...
<div style={{display: 'flex', justifyContent: 'center', gap: '20px', flexWrap: 'wrap', marginTop: '20px'}}>
  <img src={require('@site/static/img/knight.png').default} alt="Knight" style={{width: '280px', borderRadius: '8px'}} />
  <img src={require('@site/static/img/mage.png').default} alt="Mage" style={{width: '280px', borderRadius: '8px'}} />
</div>
...
> — Bill Cunningham (and also crypto)
